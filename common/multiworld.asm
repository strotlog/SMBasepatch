...
hook_tilemap_calc:
    ; orig code does this but only based on table values, we base it on whatever we want:
    ; $00 = message tilemap source (like memcpy src)
    ; $09 = message tilemap size   (like memcpy n bytes)
    pha
...
.msgbox_mwsend
    ...
    stz.b $ce
    lda #item_sent
    sta $00 ; $00 = message tilemap source
    lda #(item_sent_end-item_sent)
    sta $09 ; $09 = message tilemap size
    rts
.msgbox_mwrecv
    pla
    stz.b $ce
...
org $858246 ; inside $85:8241 Initialise message box
    jsr multiworld_messagebox_function_pointerish_calls
    bcc .normal
